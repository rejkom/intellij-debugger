...
public class JavaFeaturesExample {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("Java 21 Features Debugging Exercise");
    ...
    // Structured Concurrency (Preview feature in Java 21)
    private static void testStructuredConcurrency() throws Exception {
        ...
        try (var scope = new StructuredTaskScope.ShutdownOnFailure()) {
            ...
            var task3 = scope.fork(() -> {
                ...
                throw new RuntimeException("Task 3 failed"); // Set breakpoint here
            });
            ...
            System.err.println("Structured concurrency failed: " + e.getMessage());
        }
    }
}